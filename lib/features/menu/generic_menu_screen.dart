...
class GenericMenuScreen extends StatefulWidget {
  final MenuMetadata? initialMetadata;
  final VoidCallback? onAlertTap;

  const GenericMenuScreen({
    super.key,
  ...
  @override
  State<GenericMenuScreen> createState() => _GenericMenuScreenState();
}

class _GenericMenuScreenState extends State<GenericMenuScreen> {
          ...
          child: Column(
            ...
            children: [
              ...
              if (displayedGroups.isEmpty)
                ...
                ...displayedGroups.map((group) => GenericMenuSection(group: group)),
